...
- Updated alert messages in Components to use `button` elements as close icons instead of `a`. Both can be used, but an `a` will require `href="javascript:"` for dismissal on iOS devices.
...
## v1.1.1
- **Redesigned alerts** to be more 老年版
