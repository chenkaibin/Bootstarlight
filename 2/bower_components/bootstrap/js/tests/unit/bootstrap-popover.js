$(function () {
    ...
    module("bootstrap-popover")
      ...
      test("should render popover element", function () {
        ...
        var popover = $('<a href="javascript:" title="mdo" data-content="http://twitter.com/mdo">@mdo</a>')
      ...
      test("should get title and content from options", function () {
        $.support.transition = false
        var popover = $('<a href="javascript:">@fat</a>')
          .appendTo('#qunit-fixture')
          .popover({
            title: function () {
              return '@fat'
      ...
      test("should get title and content from attributes", function () {
        $.support.transition = false
        var popover = $('<a href="javascript:" title="@mdo" data-content="loves data attributes (づ｡◕‿‿◕｡)づ ︵ ┻━┻" >@mdo</a>')
          .appendTo('#qunit-fixture')
          .popover()
          .popover('show')
