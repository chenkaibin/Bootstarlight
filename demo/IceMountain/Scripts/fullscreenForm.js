...
;( function( window ) {
	...
	FForm.prototype._nextField = function( backto ) {
	    ...
	    var overScroll = this.current === this.fieldsCount - 2;
		// clear any previous error messagessss
		this._clearError();
	...
	FForm.prototype._progress = function() {
		if( this.options.ctrlProgress ) {
			this.ctrlProgress.style.width = (this.current+1) * ( 100 / this.fieldsCount ) + '%';
		}
	}
